...
#include "networking/wifi_connection.h"
#include "networking/tcp_connection.h"
#include "motion_control/motor_task.h"
...
void app_main(void) {
    net_status_t network_status = wifi_connect();
    ...
    //     .port = "8080"
    // };
    // xTaskCreate(tcp_task, "SERVER_SEND", 8192, &tcp_config, 1, NULL);
